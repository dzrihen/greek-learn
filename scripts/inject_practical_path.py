...
THEME_EL = {
    "food": "Φαγητό", "travel": "Ταξίδια", "health": "Υγεία", "work": "Δουλειά",
    "shopping": "Αγορές", "social": "Κοινωνικά", "housing": "Κατοικία",
    "services": "Υπηρεσίες", "emergency": "Έκτακτο",
}
...
def make_new_unit(level, uid_num, theme, n_lessons=7):
    ...
    for i in range(n_lessons):
        ...
        lessons.append(lesson(
            ...
            f"{THEME_EL[theme]} {i+1}",
            exs, xp=12 + (i % 5),
        ))
    return {"id": uid, "titleHe": f"יומיומי · {THEME_HE[theme]}", "titleRu": THEME_EL[theme], "lessons": lessons}
